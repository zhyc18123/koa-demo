define(function() {
    if (!window.AmCharts) window.AmCharts = AmCharts = {};
    AmCharts.inheriting = {};
    ...
    AmCharts.isModern = !0; - 1 != navigator.appVersion.indexOf("MSIE") && document.documentMode && (AmCharts.IEversion = Number(document.documentMode), 9 > AmCharts.IEversion && (AmCharts.isModern = !1));
    ...
    AmCharts.formatDuration = function(a, b, c, d, f, e) {
        ...
        if (a >= g[b].contains) {
            ...
            "ss" == b && (k = AmCharts.formatNumber(k, e), 1 == k.split(h)[0].length && (k = "0" + k)); ("mm" == b || "hh" == b) && 10 > k && (k = "0" + k);
            c = k + "" + d[b] + "" + c;
            a = Math.floor(a / g[b].contains);
            b = g[b].nextInterval;
            return AmCharts.formatDuration(a, b, c, d, f, e)
        }
        "ss" == b && (a = AmCharts.formatNumber(a, e), 1 == a.split(h)[0].length && (a = "0" + a)); ("mm" == b || "hh" == b) && 10 > a && (a = "0" + a);
        c = a + "" + d[b] + "" + c;
    ...
    AmCharts.SVGRenderer = AmCharts.Class({
        ...
        animate: function(a, b, c, d, f) {
            ...
            "translate" == b ? (e = (e = e.getAttribute("transform")) ? String(e).substring(10, e.length - 1) : "0,0", e = e.split(", ").join(" "), e = e.split(" ").join(","), 0 === e && (e = "0,0")) : e = e.getAttribute(b);
            c = {
                obj: a,
                frame: 0,
                attribute: b,
    ...
    AmCharts.AmChart = AmCharts.Class({
        ...
        drawBackground: function() {
            ...
            this.bgImg = a = a.image(b, 0, 0, f, e),
            d.push(a)
        },
        drawTitles: function() {
            var a = this.titles;
        ...
        measure: function() {
            ...
            if (a != this.previousWidth || e != this.previousHeight) b.style.width = a + "px",
            b.style.height = e + "px",
            f && f.setSize(a, e),
        ...
        updateAnimations: function() {
            ...
            for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                } else f.node.style[e] = Number(b.to) + b.suffix,
    ...
    AmCharts.AmBalloon = AmCharts.Class({
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var B = this.horizontalPadding,
                    z = this.verticalPadding,
                    p = this.pointerWidth,
                    t = this.pointerOrientation,
                    A = this.cornerRadius,
                    v = c.fontFamily,
                    w = this.fontSize;
                    ...
                    u = m.style;
                    u.position = "absolute";
                    m.innerHTML = '<span style="font-size:' + w + "px; color:" + this.color + "; font-family:" + v + '">' + this.text + "</span>";
                    c.chartDiv.appendChild(m);
                    this.textDiv = m;
                    w = m.offsetWidth;
                    v = m.offsetHeight;
                    m.clientHeight && (w = m.clientWidth, v = m.clientHeight);
                    var v = v + 2 * z,
                    x = w + 2 * B;
                    window.opera && (v += 2);
                    var s, C = !1;
                    ...
                    "H" != t ? (w = a - x / 2, b < h + v + 10 && "down" != t ? (C = !0, d && (b += s), s = b + p, this.deltaSignY = -1) : (d && (b -= s), s = b - v - p, this.deltaSignY = 1)) : (2 * p > v && (p = v / 2), s = b - v / 2, a < g + (k - g) / 2 ? (w = a + p, this.deltaSignX = -1) : (w = a - x - p, this.deltaSignX = 1));
                    s + v >= l && (s = l - v);
                    s < h && (s = h);
                    w < g && (w = g);
                    w + x > k && (w = k - x);
                    ...
                    y = this.bulletSize,
                    D;
                    0 < A || 0 === p ? (0 < z && (a = AmCharts.rect(f, x, v, n, 0, B + 1, E, z, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), e.push(a)), n = AmCharts.rect(f, x, v, n, this.fillAlpha, B, q, this.borderAlpha, this.cornerRadius), this.showBullet && (D = AmCharts.circle(f, y, r, this.fillAlpha), e.push(D))) : (r = [], A = [], "H" != t ? (g = a - w, g > x - p && (g = x - p), g < p && (g = p), r = [0, g - p, a - w, g + p, x, x, 0, 0], A = C ? [0, 0, b - s, 0, 0, v, v, 0] : [v, v, b - s, v, v, 0, 0, v]) : (r = b - s, r > v - p && (r = v - p), r < p && (r = p), A = [0, r - p, b - s, r + p, v, v, 0, 0], r = a < g + (k - g) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, x, x, 0] : [x, x, w + x > a ? x: a - w, x, x, 0, 0, x]), 0 < z && (a = AmCharts.polygon(f, r, A, n, 0, B, E, z), a.translate(1, 1), e.push(a)), n = AmCharts.polygon(f, r, A, n, this.fillAlpha, B, q, this.borderAlpha));
                    this.bg = n;
                    e.push(n);
                    n.toFront();
                    f = 1 * this.deltaSignX;
                    ...
                    this.bottom = s + v + 1;
                    this.yPos = n.y + s;
                    D && D.translate(this.pointToX - w + f, b - s);
        ...
        hide: function() {
            ...
            if (0 < b) {
                ...
                a.show = !1;
                var d = a.set;
                d && (d.setAttr("opacity", a.fillAlpha), d.animate({
                    opacity: 0
                },
                b, "easeInSine"));
                a.textDiv && c.animate({
    ...
    AmCharts.handDrawnLine = function(a, b, c, d, f, e, g, h, k, l, m) {
        var n = a.set();
        for (m = 1; m < b.length; m++) for (var q = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(q, r, a.handDrawScatter), q = r[0], r = r[1], B = 1; B < q.length; B++) n.push(AmCharts.line(a, [q[B - 1], q[B]], [r[B - 1], r[B]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
        return n
    };
    ...
    AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
        ...
        d = a.set();
        var E;
        B && (z = q(10 * z), A = q(10 * A), w = q(10 * w), x = q(10 * x), t = q(10 * t), v = q(10 * v), u = q(10 * u), p = q(10 * p), b = q(10 * b), k = q(10 * k), c = q(10 * c), e *= 10, g *= 10, h *= 10, r *= 10, 1 > Math.abs(f) && 1 >= Math.abs(w - A) && 1 >= Math.abs(u - v) && (E = !0));
        f = "";
        var y;
        0 < k && (B ? (y = " M" + z + "," + (t + k) + " L" + A + "," + (v + k), E || (y += " A" + (b - e) + "," + (k + c - g) + "," + (b + e) + "," + (k + c + g) + "," + A + "," + (v + k) + "," + w + "," + (u + k)), y += " L" + x + "," + (p + k), 0 < h && (E || (y += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + x + "," + (k + p) + "," + z + "," + (k + t)))) : (y = " M" + z + "," + (t + k) + " L" + A + "," + (v + k) + (" A" + e + "," + g + ",0," + C + ",1," + w + "," + (u + k) + " L" + x + "," + (p + k)), 0 < h && (y += " A" + h + "," + r + ",0," + C + ",0," + z + "," + (t + k))), y += " Z", y = a.path(y, void 0, void 0, "1000,1000").attr(s), d.push(y), y = a.path(" M" + z + "," + t + " L" + z + "," + (t + k) + " L" + A + "," + (v + k) + " L" + A + "," + v + " L" + z + "," + t + " Z", void 0, void 0, "1000,1000").attr(s), k = a.path(" M" + w + "," + u + " L" + w + "," + (u + k) + " L" + x + "," + (p + k) + " L" + x + "," + p + " L" + w + "," + u + " Z", void 0, void 0, "1000,1000").attr(s), d.push(y), d.push(k));
        B ? (E || (f = " A" + q(b - e) + "," + q(c - g) + "," + q(b + e) + "," + q(c + g) + "," + q(A) + "," + q(v) + "," + q(w) + "," + q(u)), e = " M" + q(z) + "," + q(t) + " L" + q(A) + "," + q(v) + f + " L" + q(x) + "," + q(p)) : e = " M" + z + "," + t + " L" + A + "," + v + (" A" + e + "," + g + ",0," + C + ",1," + w + "," + u) + " L" + x + "," + p;
        0 < h && (B ? E || (e += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + x + "," + p + "," + z + "," + t) : e += " A" + h + "," + r + ",0," + C + ",0," + z + "," + t);
        a.handDrawn && (b = AmCharts.line(a, [z, A], [t, v], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l["stroke-opacity"]), d.push(b));
    ...
    AmCharts.adjustLuminosity = function(a, b) {
        ...
        var c = "#",
        d, f;
        for (f = 0; 3 > f; f++) d = parseInt(a.substr(2 * f, 2), 16),
    ...
    AmCharts.AmLegend = AmCharts.Class({
        ...
        arrangeEntries: function() {
            ...
            for (A = 0; A < p.length; A++) {
                var x = p[A];
                this.reversedOrder && (x = p[p.length - A - 1]);
                t = x.getBBox();
                var s;
                this.equalWidths ? s = e + w * (q + m + this.markerLabelGap) : (s = u, u = u + t.width + e + m);
                s + t.width > n && 0 < A && 0 !== w && (v++, w = 0, s = e, u = s + t.width + e + m);
                x.translate(s, (r + l) * v);
                w++; ! isNaN(k) && w >= k && (w = 0, v++);
                B.push(x)
            }
            t = B.getBBox();
            k = t.height + 2 * l - 1;
            "left" == a || "right" == a ? (h = t.width + 2 * e, g.style.width = h + b + c + "px") : h = h - b - c - 1;
            ...
            c.toBack();
            b = e;
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)"center" == this.align ? b = e + (h - t.width) / 2 : "right" == this.align && (b = e + h - t.width);
            B.translate(b, l + 1);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend) {
                ...
                var e; ! 0 === a.hidden && (e = d = this.markerDisabledColor);
                var g = a.pattern,
                h = a.customMarker;
                ...
                l = this.markerSize,
                m = 0;
                if (this.useGraphSettings) if (c = a.type, "line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) this.switchType = void 0,
                g = k.set(),
                a.hidden || (d = a.lineColor, e = a.bulletBorderColor),
                m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength),
                g.push(m),
                a.bullet && (a.hidden || (d = a.bulletColor), m = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (m.translate(l + 1, l / 2), g.push(m)),
                m = l;
                else {
                    var n;
                    a.getGradRotation && (n = a.getGradRotation()); (g = this.createMarker("square", a.fillColors, a.fillAlphas, a.lineThickness, d, a.lineAlpha, n, g)) && g.translate(l / 2, l / 2)
                ...
                if (e = this.switchType) n = "x" == e ? this.createX() : this.createV(),
                n.dItem = a,
                !0 !== a.hidden ? "x" == e ? n.hide() : n.show() : "x" != e && n.hide(),
                this.switchable || n.hide(),
                this.addListeners(n, a),
                a.legendSwitch = n,
                k.push(n);
                e = this.color;
                a.showBalloon && this.textClickEnabled && void 0 !== this.selectedColor && (e = this.selectedColor);
                this.useMarkerColorForLabels && (e = d); ! 0 === a.hidden && (e = this.markerDisabledColor);
                ...
                var q;
                d && (d = AmCharts.fixNewLines(d), a.legendTextReal = d, q = AmCharts.text(this.container, d, e, b.fontFamily, n, "start"), q.translate(this.lx + m, this.ly), k.push(q), b = q.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
        ...
        createValue: function(a) {
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (b.valueText) {
                    var e = b.color;
                    b.useMarkerColorForValues && (e = a.color, a.legendKeyColor && (e = a.legendKeyColor())); ! 0 === a.hidden && (e = b.markerDisabledColor);
                    var g = b.valueText,
        ...
        updateValues: function() {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                } else e = b.formatString(this.valueText, f); (g = f.legendLabel) && g.text(f.legendTextReal);
                d.text(e)
            }
        },
        renderFix: function() {
    ...
    AmCharts.AmMap = AmCharts.Class({
        ...
        construct: function() {
            ...
            this.createEvents("rollOverMapObject", "rollOutMapObject", "clickMapObject", "selectedObjectChanged", "homeButtonClicked", "zoomCompleted", "writeDevInfo", "click");
            this.zoomDuration = 1;
        ...
        initChart: function() {
            ...
            if (this.sizeChanged && AmCharts.hasSVG && this.chartCreated) {
                ...
                this.drawBg();
                var b = this.smallMap;
                b && b.init(this, a); (b = this.valueLegend) && b.init(this, a);
                this.sizeChanged = !1;
            ...
            } else(AmCharts.AmMap.base.initChart.call(this), AmCharts.hasSVG) ? (this.dataChanged && (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, a = this.legend) && (a.position = "absolute", a.invalidateSize()), this.addMouseWheel(), this.createDescriptionsDiv(), this.svgAreas = [], this.svgAreasById = {},
            this.drawChart()) : (document.createTextNode(this.svgNotSupported), this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported)
        },
        invalidateSize: function() {
        ...
        addMouseWheel: function() {
            var a = this;
            a.mouseWheelZoomEnabled && window.addEventListener && (window.addEventListener("DOMMouseScroll",
            function(b) {
        ...
        buildEverything: function() {
            ...
            if (0 < a.realWidth && 0 < a.realHeight) {
                ...
                a.processAreas(); (c = a.valueLegend) && c.init(a, b);
                if (b = a.objectList) a.clearObjectList(),
                b.init(a);
        ...
        handleMouseDown: function(a) {
            if (this.chartCreated && this.mouseIsOver && (AmCharts.resetMouseOver(), this.mouseIsOver = !0, this.dragMap && (this.stopAnimation(), this.isDragging = !0, this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y, this.panEventsEnabled || a && a.preventDefault && a.preventDefault()), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
                var b = this.mouseX,
                c = this.mouseY,
                d = a.touches.item(1);
        ...
        handleReleaseOutside: function() {
            ...
            isNaN(b) || isNaN(c) || !(2 < Math.abs(a.x - b) || Math.abs(a.y - c)) || (this.mapWasDragged = !0); ! this.mouseIsOver || this.mapWasDragged || this.skipClick || (a = {
                type: "click",
                x: this.mouseX,
                y: this.mouseY,
                chart: this
        ...
        handleMouseMove: function(a) {
            ...
            b.isDragging && (b.hideBalloon(), g.translate(g.x + (f - c), g.y + (e - d), g.scale), b.updateSmallMap(), a && a.preventDefault && a.preventDefault());
            b.previuosMouseX = f;
            b.previuosMouseY = e
        },
        selectObject: function(a) {
            ...
            c = b.zoomDuration; ! f && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY) ? (b.showDescriptionAndGetUrl(), b.processObjects()) : (b.selectedObjectTimeOut = setTimeout(function() {
            ...
            if (c = a.groupId) for (e = b.getGroupById(c), g = 0; g < e.length; g++) {
                var h = e[g];
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                "MapArea" == a.objectType && b.setAttr("fill-opacity", a.alphaReal); (c = a.pattern) && b.pattern(c, this.mapScale); (b = a.imageLabel) && !a.labelInactive && b.setAttr("fill", a.labelColorReal)
            }
        },
        ...
        processObjects: function() {
            ...
            c.toFront();
            b.toFront();
            if (a = this.selectedObject) this.imagesProcessor.reset(),
        ...
        showAsRolledOver: function(a) {
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                d;
                void 0 != c && ("MapImage" == a.objectType ? (d = a.image) && d.setAttr("fill", c) : b.setAttr("fill", c)); (d = a.imageLabel) && !a.labelInactive && (c = a.labelRollOverColorReal, void 0 != c && d.setAttr("fill", c));
        ...
        rollOverMapObject: function(a, b) {
            if (this.chartCreated) {
                ...
                if (this.showDescriptionOnHover) this.showDescription(a);
                    ...
                    c = a.colorReal;
                    d = "";
                    void 0 !== c && this.useObjectColorForBalloon || (c = f.fillColor);
                    clearTimeout(this.hoverInt); (f = a.balloonTextReal) && (d = this.formatString(f, a));
                    this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this));
                    if (d && "" !== d) {
                        var e, g;
                        "MapArea" == a.objectType && (g = this.getAreaCenterLatitude(a), e = this.getAreaCenterLongitude(a), g = this.latitudeToCoordinate(g), e = this.longitudeToCoordinate(e));
                        this.showBalloon(d, c, this.mouseIsOver, e, g)
                    }
                }
                g = {
        ...
        checkIfClickable: function(a) {
            if (!0 === a.selectable || "MapArea" == a.objectType && a.autoZoomReal || a.url || a.linkToObject || 0 < a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description) return ! 0;
            var b = this.allowClickOnSelectedObject;
            return this.selectedObject == a && b ? !0 : !1
        },
        ...
        extendMapData: function(a) {
            var b = a.objectType;
            if ("MapImage" != b && "MapArea" != b && "MapLine" != b) return AmCharts.extend(a, new AmCharts.MapData),
            this.dataProvider = a,
            this.zoomInstantly = !0,
            this.validateData(),
            !0
    ...
    AmCharts.ZoomControl = AmCharts.Class({
        ...
        init: function(a, b) {
            ...
            if (c.zoomControlEnabled) {
                ...
                c.set = d;
                c.zoomSet = p;
                var t = AmCharts.rect(b, f + 6, q + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4);
                t.translate( - 3, -3);
                t.mouseup(function() {
                    c.handleBgUp()
                });
                ...
                t.init(b, f, f, e, g, h, k, l, m, n);
                p.push(t.set);
                t = new AmCharts.SimpleButton;
                t.setIcon(a.pathToImages + "minus.gif", c.iconSize);
                t.setClickHandler(a.zoomOut, a);
                t.init(b, f, f, e, g, h, k, l, m, n);
                t.set.translate(0, q + f);
                p.push(t.set);
                var A = Math.log(z / B) / Math.log(r) + 1,
                t = q / A,
                v;
                for (v = 1; v < A; v++) {
                    var w = f + v * t,
                ...
                A.init(b, f, t, e, g, h, k, l, m, n);
                p.push(A.set);
                c.dragger = A.set;
                c.previousY = NaN;
                q -= t;
                B = Math.log(B / 100) / Math.log(r);
                r = Math.log(z / 100) / Math.log(r);
                c.realStepSize = q / (r - B);
                c.realGridHeight = q;
                c.stepMax = r
            }
            c.panControlEnabled && (r = b.set(), d.push(r), p && p.translate(f, 4 * f), p = new AmCharts.SimpleButton, p.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), p.setClickHandler(a.moveLeft, a), p.init(b, f, f, e, g, h, k, l, m, n), p.set.translate(0, f), r.push(p.set), p = new AmCharts.SimpleButton, p.setIcon(a.pathToImages + "panRight.gif", c.iconSize), p.setClickHandler(a.moveRight, a), p.init(b, f, f, e, g, h, k, l, m, n), p.set.translate(2 * f, f), r.push(p.set), p = new AmCharts.SimpleButton, p.setIcon(a.pathToImages + "panUp.gif", c.iconSize), p.setClickHandler(a.moveUp, a), p.init(b, f, f, e, g, h, k, l, m, n), p.set.translate(f, 0), r.push(p.set), p = new AmCharts.SimpleButton, p.setIcon(a.pathToImages + "panDown.gif", c.iconSize), p.setClickHandler(a.moveDown, a), p.init(b, f, f, e, g, h, k, l, m, n), p.set.translate(f, 2 * f), r.push(p.set), g = new AmCharts.SimpleButton, g.setIcon(a.pathToImages + "homeIcon.gif", c.iconSize), g.setClickHandler(a.goHome, a), g.init(b, f, f, e, 0, 0, k, 0, m, n), g.set.translate(f, f), r.push(g.set), d.push(r))
        },
    ...
    AmCharts.AreasProcessor = AmCharts.Class({
        ...
        process: function(a) {
            ...
            isNaN(b.minValue) || (u = b.minValue);
            isNaN(b.maxValue) || (w = b.maxValue);
            b.maxValueReal = w;
            b.minValueReal = u;
            for (f = 0; f < d; f++) e = a[f],
            isNaN(e.value) ? e.percents = void 0 : e.percents = 100 * ((e.value - u) / g);
            for (f = 0; f < d; f++) {
                e = a[f];
                ...
                var x = e.alpha;
                isNaN(x) && (x = l);
                var s = e.rollOverAlpha;
                isNaN(s) && (s = r);
                isNaN(s) && (s = x);
                var C = e.rollOverColor;
                void 0 == C && (C = n);
                var E = e.pattern;
                void 0 == E && (E = A);
                var y = e.selectedColor;
                void 0 == y && (y = q);
                var D = e.balloonText;
                D || (D = p);
                if (void 0 != c.colorSolid && !isNaN(e.value)) {
                    var F = (e.value - u) / (w - u),
                    I = 100 / (b.colorSteps - 1),
                    F = Math.ceil(100 * F / I) * I / 100;
                    e.colorReal = AmCharts.getColorFade(g, c.colorSolid, F)
                }
                void 0 != e.color && (e.colorReal = e.color);
                void 0 == e.selectable && (e.selectable = t);
                void 0 == e.colorReal && (e.colorReal = k);
                F = e.outlineColor;
                void 0 == F && (F = B);
                I = e.outlineAlpha;
                isNaN(I) && (I = z);
                var K = e.outlineThickness;
                isNaN(K) && (K = m);
                var H = e.rollOverOutlineColor;
                void 0 == H && (H = v);
                e.alphaReal = x;
                e.rollOverColorReal = C;
                e.rollOverAlphaReal = s;
                e.balloonTextReal = D;
                e.selectedColorReal = y;
                e.outlineColorReal = F;
                e.outlineAlphaReal = I;
                e.rollOverOutlineColorReal = H;
                e.patternReal = E;
                AmCharts.processDescriptionWindow(c, e);
                if (C = h[e.id]) if (s = C.area, (C = C.title) && !e.title && (e.title = C), s) {
                    e.displayObject = s;
                    e.mouseEnabled && b.addObjectEventListeners(s, e);
                    var J;
                    void 0 != g && (J = g);
                    void 0 != e.colorReal && (J = e.showAsSelected || b.selectedObject == e ? e.selectedColorReal: e.colorReal);
                    s.setAttr("fill", J);
                    s.setAttr("stroke", F);
                    s.setAttr("stroke-opacity", I);
                    s.setAttr("stroke-width", K);
                    s.setAttr("fill-opacity", x);
                    E && s.pattern(E, b.mapScale)
                }
            }
        },
        updateAllAreas: function() {
            ...
            for (l = 0; l < g.length; l++) if (h = g[l], void 0 != c && h.setAttr("fill", c), isNaN(d) || h.setAttr("fill-opacity", d), void 0 != f && h.setAttr("stroke", f), isNaN(e) || h.setAttr("stroke-opacity", e), h.setAttr("stroke-width", b.outlineThickness), a.getAreasFromMap && !k[h.id]) {
    ...
    AmCharts.ImagesProcessor = AmCharts.Class({
        ...
        createImage: function(a, b) {
            ...
            void 0 == r && (r = l);
            l = a.selectedColor;
            void 0 == l && (l = m); (m = a.balloonText) || (m = n);
            n = a.outlineColor;
            void 0 == n && (n = q);
            void 0 == n && (n = x);
            q = a.outlineThickness;
            isNaN(q) && (q = B); (B = a.labelPosition) || (B = p);
            p = a.labelColor;
            void 0 == p && (p = t);
            t = a.labelRollOverColor;
            void 0 == t && (t = v);
            v = a.selectedLabelColor;
            void 0 == v && (v = w);
            w = a.labelFontSize;
            isNaN(w) && (w = A);
            A = a.selectedScale;
            ...
            var s;
            v || w || r || (w = "circle", t = 1, k = h = 0);
            p = z = 0;
            A = a.selectedColorReal;
            w ? (isNaN(t) && (t = 10), isNaN(l) && (l = 10), "kilometers" == a.widthAndHeightUnits && (t = c.kilometersToPixels(a.width), l = c.kilometersToPixels(a.height)), "miles" == a.widthAndHeightUnits && (t = c.milesToPixels(a.width), l = c.milesToPixels(a.height)), s = this.createPredefinedImage(x, n, q, w, t, l), p = z = 0, a.centeredReal && (z = isNaN(a.right) ? -t / 2 : t / 2, p = isNaN(a.bottom) ? -l / 2 : l / 2), s.translate(z, p)) : v ? (isNaN(t) && (t = 10), isNaN(l) && (l = 10), s = d.image(v, 0, 0, t, l), s.node.setAttribute("preserveAspectRatio", "none"), s.setAttr("opacity", h), a.centeredReal && (z = isNaN(a.right) ? -t / 2 : t / 2, p = isNaN(a.bottom) ? -l / 2 : l / 2, s.translate(z, p))) : r && (s = d.path(r), n = s.getBBox(), a.centeredReal ? (z = -n.x * g - n.width * g / 2, isNaN(a.right) || (z = -z), p = -n.y * g - n.height * g / 2, isNaN(a.bottom) || (p = -p)) : z = p = 0, s.translate(z, p, g), s.x = z, s.y = p);
            s && (u.push(s), a.image = s, s.setAttr("stroke-opacity", k), s.setAttr("fill-opacity", h), s.setAttr("fill", x)); ! a.showAsSelected && c.selectedObject != a || void 0 == A || s.setAttr("fill", A);
            x = null;
            void 0 !== a.label && (x = AmCharts.text(d, a.label, a.labelColorReal, c.fontFamily, a.labelFontSizeReal, a.labelAlign), h = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < h && (s = x.getBBox(), d = AmCharts.rect(d, s.width + 16, s.height + 10, k, h), d.translate( - 3, -s.height / 2 - 5), u.push(d)), a.imageLabel = x, !a.labelInactive && a.mouseEnabled && c.addObjectEventListeners(x, a), u.push(x));
        ...
        process: function(a) {
            ...
            for (w = 0; w < b.length; w++) {
                ...
                if (u.remainVisible || c.selectedObject == u.parentObject) {
                    ...
                    var y = u.alpha;
                    isNaN(y) && (y = B);
                    var D = u.rollOverAlpha;
                    isNaN(D) && (D = t);
                    isNaN(D) && (D = y);
                    var F = u.rollOverColor;
                    void 0 == F && (F = z);
                    var I = u.selectedColor;
                    void 0 == I && (I = p);
                    var K = u.balloonText;
                    K || (K = A);
                    var H = u.arrow;
                    ...
                    u.alphaReal = y;
                    u.colorReal = E;
                    u.rollOverColorReal = F;
                    u.rollOverAlphaReal = D;
                    u.balloonTextReal = K;
                    u.selectedColorReal = I;
                    u.thicknessReal = s;
                    AmCharts.processDescriptionWindow(d, u);
                    var D = this.processCoordinates(u.x, c.realWidth),
                    F = this.processCoordinates(u.y, c.realHeight),
                    P = u.longitudes,
                    K = u.latitudes,
                    R = P.length,
                    N;
                    if (0 < R) for (D = [], N = 0; N < R; N++) D.push(c.longitudeToCoordinate(P[N]));
                    R = K.length;
                    if (0 < R) for (F = [], N = 0; N < R; N++) F.push(c.latitudeToCoordinate(K[N]));
                    if (0 < D.length) {
                        AmCharts.dx = 0;
                        AmCharts.dy = 0;
                        P = AmCharts.line(v, D, F, E, 1, s, C, !1, !1, !0);
                        C = AmCharts.line(v, D, F, E, 0.001, 3, C, !1, !1, !0);
                        AmCharts.dx = 0.5;
                        AmCharts.dy = 0.5;
                        x.push(P);
                        x.push(C);
                        ...
                        if ("none" != H) {
                            var G, O, Q;
                            if ("end" == H || "both" == H) y = D[D.length - 1],
                            C = F[F.length - 1],
                            1 < D.length ? (E = D[D.length - 2], G = F[F.length - 2]) : (E = y, G = C),
                            G = 180 * Math.atan((C - G) / (y - E)) / Math.PI,
                            O = y,
                            Q = C,
                            G = 0 > y - E ? G - 90 : G + 90;
                            "both" == H && (y = AmCharts.polygon(v, [ - L / 2, 0, L / 2], [1.5 * L, 0, 1.5 * L], J, M, 1, J, M), x.push(y), y.translate(O, Q), y.rotate(G), u.fixedSize && f.push(y));
                            if ("start" == H || "both" == H) y = D[0],
                            Q = F[0],
                            1 < D.length ? (C = D[1], O = F[1]) : (C = y, O = Q),
                            G = 180 * Math.atan((Q - O) / (y - C)) / Math.PI,
                            O = y,
                            G = 0 > y - C ? G - 90 : G + 90;
                            "middle" == H && (y = D[D.length - 1], C = F[F.length - 1], 1 < D.length ? (E = D[D.length - 2], G = F[F.length - 2]) : (E = y, G = C), O = E + (y - E) / 2, Q = G + (C - G) / 2, G = 180 * Math.atan((C - G) / (y - E)) / Math.PI, G = 0 > y - E ? G - 90 : G + 90);
                            y = AmCharts.polygon(v, [ - L / 2, 0, L / 2], [1.5 * L, 0, 1.5 * L], J, M, 1, J, M);
                            x.push(y);
                            y.translate(O, Q);
                            y.rotate(G);
                            u.fixedSize && f.push(y)
                        }
                        u.fixedSize && P && this.linesToResize.push({
                            line: P,
                            thickness: s
                        });
                        u.showAsSelected && !isNaN(I) && P.setAttr("stroke", I);
                        0 < K.length ? e.push(x) : g.push(x)
                    }
                }
            }
            a.parentObject && a.remainVisible && this.process(a.parentObject)
    ...
    AmCharts.ValueLegend = AmCharts.Class({
        ...
        init: function(a, b) {
            ...
            if (this.showAsGradient) c = AmCharts.rect(b, this.width, this.height, [c, d], 1, this.borderThickness, this.borderColor, 1, 0, 0),
            c.translate(0, g),
            e.push(c);
            else for (k = this.width / f, l = 0; l < f; l++) m = AmCharts.getColorFade(c, d, 1 * l / (f - 1)),
    ...
    AmCharts.ObjectList = AmCharts.Class({
        ...
        addObjects: function(a, b) {
            ...
            if (a.images) for (f = 0; f < a.images.length; f++) e = a.images[f],
            void 0 === e.showInList && (e.showInList = c.showImagesInList),
            this.addObject(e, d);
            if (a.lines) for (f = 0; f < a.lines.length; f++) e = a.lines[f],
            void 0 === e.showInList && (e.showInList = c.showLinesInList),
            this.addObject(e, d);
