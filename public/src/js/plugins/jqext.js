	...
	*/
    ...
    $.extend({  
	    browser: (function() {  
			...
			browser.mozilla = /firefox/.test(ua.toLowerCase());  
		    browser.webkit = /webkit/.test(ua.toLowerCase());  
		    browser.opera = /opera/.test(ua.toLowerCase());  
		    browser.msie = /msie/.test(ua.toLowerCase());
		    browser.safari = /safari/.test(ua.toLowerCase());
	        return browser;  
	    })()
	});  
	 ...
	 */
	var _val = $.fn.val;
	load = !(typeof load == 'undefined') ? load : {}
